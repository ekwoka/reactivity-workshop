...
declare module 'highlight.js' {
  ...
  interface PublicApi {
    ...
    inherit: <T>(original: T, ...args: Record<string, unknown>[]) => T;
  ...
  interface ModesAPI {
    ...
    COMMENT: (
      ...
      modeOpts?: Mode | Record<string, unknown>,
    ) => Mode;
  ...
  export type CompilerExt = (
    mode: Mode,
    parent: Mode | Language | null,
  ) => void;
